...
public class CensoredPrintWriter extends Writer {
    ...
    /**
     * Creates a new CensoredPrinterWriter, without automatic line flushing.
     *
    ...
    /**
     * Creates a new CensoredPrinterWriter.
     *
     * @param  out        A character-output stream
    ...
    /**
     * Creates a new CensoredPrinterWriter, without automatic line flushing, from an
    ...
    /**
     * Creates a new CensoredPrinterWriter from an existing OutputStream.  This
    ...
    /**
     * Creates a new CensoredPrinterWriter, without automatic line flushing, with the
    ...
    /* Private constructor */
    private CensoredPrintWriter(Charset charset, File file)
            throws FileNotFoundException
    {
     ...
     * @since  1.5
     */
    public CensoredPrintWriter(String fileName, String csn)
     ...
     * @since  1.5
     */
    public CensoredPrintWriter(File file, String csn)
            throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     * @since  1.5
     */
    public CensoredPrintWriter printf(Locale l, String format, Object ... args) {
     ...
     * @since  1.5
     */
    public CensoredPrintWriter format(String format, Object ... args) {
        try {
            synchronized (lock) {
                ensureOpen();
                if ((formatter == null)
     ...
     * @since  1.5
     */
    public CensoredPrintWriter format(Locale l, String format, Object ... args) {
        try {
            synchronized (lock) {
                ensureOpen();
     ...
     * @since  1.5
     */
    public CensoredPrintWriter append(CharSequence csq) {
        if (csq == null)
            write("null");
        else
            write(csq.toString());
     ...
     * @since  1.5
     */
    public CensoredPrintWriter append(CharSequence csq, int start, int end) {
     ...
     * @since 1.5
     */
    public CensoredPrintWriter append(char c) {
        write(c);
        return this;
    }
